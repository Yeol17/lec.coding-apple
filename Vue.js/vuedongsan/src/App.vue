<template>
	...
	<Transition name="fade">
		<Modal @closeModal="모달창열렸니 = false" :원룸들="원룸들" :누른거="누른거" :모달창열렸니="모달창열렸니" :disRate="disRate" />
	</Transition>
...
export default {
	...
	methods: {
		info() {
			console.log(this.원룸들)
			console.log(this.원룸들오리지널)
		},
		open(n) {
			this.모달창열렸니 = true;
			this.누른거 = n;
